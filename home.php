...
<head>
  ...
  <style>
      .my-custom-navbar {
        background-color: blue !important; /* Use !important to ensure it takes precedence */
    }
 ...
 <div class="container">
    ...
    <div class="row">
      ...
      <i class="icon-calendar icon-large"></i>
                ...
                $Today = date('y:m:d', mktime(date('H'), date('i'), date('s'), date('m'), date('d'), date('Y')));
     ...
     <input style="width:150px;background: #02232e;color: #fff;border-radius: 5px;height: 30px;" readonly type="submit" class="trans" name="face" value="">
      </form><!--*****Clock******-->
  ...
  <div class="container">
    <div class="row">
      <table class="table table-bordered table-striped table-hover" id="resultTable" data-responsive="table">
        ...
        <thead>
        <tr style="background-color: #02232e; color: #FFFFFF;" >
            <th> Medicine </th>
            <th> Category</th>
            <th style="background: #black;"> Expiry Date</th>
            <th> Price </th>
            <th> Qty </th>
            <th> Amount </th>
            <th> Action </th>
