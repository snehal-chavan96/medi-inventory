<!-- For more projects: Visit dopedevelopers.com  -->
<?php
...
<body>
  ...
  <div class="container">
    ...
    <a href="home.php?invoice_number=<?php echo $_GET['invoice_number'] ?>"><button class="btn btn-default"><i
    ...
    <div id="content">
      ...
      <form method="POST" action="save_invoice.php">
        <table class="table table-bordered table-hover" border="1" cellpadding="4" cellspacing="0"
          ...
          <tbody><!-- For more projects: Visit dopedevelopers.com  -->
            <?php
            ...
            <tr>
              <td colspan="4" style=" text-align:right;"><strong style="font-size: 12px;">Paid Amount: &nbsp;</strong>
              </td>
              <td colspan="2"><strong style="font-size: 12px;">
                  <?php
            ...
            <tr>
              <td colspan="4" style=" text-align:right;"><strong style="font-size: 18px;">&nbsp;&nbsp;Change Amount:
                  &nbsp;</strong></td>
              <td colspan="2"><strong style="font-size: 12px;">
                  <?php
    ...
    <a href="javascript:Clickheretoprint()" class="btn btn-danger btn-md" style="float: right;"><i
        class="icon icon-print"></i> Print</a>

    </form>
</body>

</html><!-- For more projects: Visit dopedevelopers.com  -->